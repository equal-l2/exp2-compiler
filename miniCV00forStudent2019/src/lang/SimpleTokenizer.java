...
//for JUnit
//	public SimpleTokenizer(String s, AbstractTokenRule rule) {
//		this.rule = rule;
//		byte[] b = s.getBytes();
//		IOContext ioCtx = new IOContext(new ByteArrayInputStream(b), System.out, System.out);
//		setNewIOContext(ioCtx);
//		lineNo = 1; colNo = 0;
//		setupCharSet();
//	}
// end for JUnit
